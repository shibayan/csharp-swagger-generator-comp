...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class StoreApi : IStoreApi
    {
        ...
        /// <param name="orderId">ID of the order that needs to be deleted</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Org.OpenAPITools.Client.ApiResponse<Object> DeleteOrderWithHttpInfo (long orderId)
        {
            ...
            if (orderId != null)
                requestOptions.PathParameters.Add("orderId", Org.OpenAPITools.Client.ClientUtils.ParameterToString(orderId)); // path parameter


            // make the HTTP request

            var response = this.Client.Delete<Object>("/store/order/{orderId}", requestOptions, this.Configuration);
        ...
        /// <param name="orderId">ID of the order that needs to be deleted</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Object>> DeleteOrderAsyncWithHttpInfo (long orderId)
        {
            // verify the required parameter 'orderId' is set
            if (orderId == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'orderId' when calling StoreApi->DeleteOrder");
            ...
            var response = await this.AsynchronousClient.DeleteAsync<Object>("/store/order/{orderId}", requestOptions, this.Configuration);
        ...
        public Org.OpenAPITools.Client.ApiResponse< Order > GetOrderByIdWithHttpInfo (long orderId)
        {
            ...
            var response = this.Client.Get< Order >("/store/order/{orderId}", requestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Order>> GetOrderByIdAsyncWithHttpInfo (long orderId)
        {
            ...
            var response = await this.AsynchronousClient.GetAsync<Order>("/store/order/{orderId}", requestOptions, this.Configuration);
