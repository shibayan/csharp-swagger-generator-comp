...
namespace Swagger
{
    ...
    public partial class SwaggerPetstore : ServiceClient<SwaggerPetstore>, ISwaggerPetstore
    {
        ...
        {
            BaseUri = new System.Uri("https://petstore.swagger.io/v2");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<ApiResponse>> UploadFileWithHttpMessagesAsync(long petId, string additionalMetadata = default(string), Stream file = default(Stream), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<Order>> GetOrderByIdWithHttpMessagesAsync(long orderId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (orderId > 10)
            {
            ...
            _url = _url.Replace("{orderId}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(orderId, SerializationSettings).Trim('"')));
            // Create HTTP transport objects
            var _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
            _httpRequest.Method = new HttpMethod("GET");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse> DeleteOrderWithHttpMessagesAsync(long orderId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (orderId < 1)
            {
                throw new ValidationException(ValidationRules.InclusiveMinimum, "orderId", 1);
